"""Этот код пишет телеграм бота, который отправляет котировки BTCUSD."""
import enum
import logging
import os
import sys
...
def repl():  # read eval print loop
    """При нажатии на 'S' тормозит бесконечный."""
    """Цикл и переходит к другой функции."""
    global state
    while True:
        # Переделать для Streighten_ur_back_bot. Добавить кнопку
        # /exit и по нажатии, блокируется и переходит к другой ф-ии
